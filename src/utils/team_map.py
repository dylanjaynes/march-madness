...
TEAM_ALIASES: dict[str, list[str]] = {
    ...
    "Cal Baptist": ["Cal Baptist", "Cal Baptist Lancers", "California Baptist", "California Baptist Lancers"],
    ...
    "McNeese State": ["McNeese St.", "McNeese State Cowboys", "McNeese", "McNeese Cowboys"],
    ...
    "St. John's (NY)": ["St. John's", "St. Johns", "St.Johns", "Saint John's", "St. John's Red Storm", "St John's", "St. John's (NY) Red Storm"],
    ...
    "Queens": ["Queens (NC)", "Queens NC", "Queens University", "Queens University Royals", "Queens (NC) Royals"],
...
_NEW_CANONICALS: dict[str, str] = {
    ...
    "Incarnate Word": "Incarnate Word",
    "Tarleton State": "Tarleton State",
    # "Queens (NC)" intentionally omitted — Torvik uses "Queens"; alias handled in TEAM_ALIASES
    "Alabama A&M": "Alabama A&M",
    "Eastern Kentucky": "Eastern Kentucky",
    "Evansville": "Evansville",
    "Fairfield": "Fairfield",
